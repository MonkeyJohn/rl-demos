...
from pg_cp import run_episode, discount_rewards
import gym
import numpy as np
...
tf.app.flags.DEFINE_integer("num_steps", 2000, "Maximum number of updates")

tf.app.flags.DEFINE_integer("sec", 20, "save after how many seconds")
