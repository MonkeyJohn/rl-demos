...
tf.app.flags.DEFINE_boolean("preprocess", False, "Whether to preprocess input")
tf.app.flags.DEFINE_string("actions", "0,1", "action space as comma separated strings")
tf.app.flags.DEFINE_integer("inp_dim", 4, "Input dimension for problem")
